...
(def execute-story-task
  ...
  Takes a story-name argument and guides the agent through executing the next
  incomplete task from the story's task breakdown, managing the task queue and
  completion tracking."
  "---
