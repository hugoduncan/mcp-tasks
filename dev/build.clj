...
(defn generate-prompt-manifest
  "Generate Clojure source file listing all workflow prompts.

  Scans resources/prompts/ directory and creates src/mcp_tasks/generated_workflows.clj
  containing a vector of workflow prompt names (without .md extension).

  This approach embeds the workflow list directly in compiled code, which works
  ...
  (let [prompts-dir (io/file "resources/prompts")
        ...
        content (str "(ns mcp-tasks.generated-workflows\n"
                     "  \"Auto-generated workflow list for GraalVM native image compatibility.\n"
                     "  \n"
    ...
    (println (format "Generated workflow list with %d prompts in %s"
