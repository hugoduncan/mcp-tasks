...
(deftest prompts-install-command-installs-prompts
  ...
  (testing "prompts-install-command"
    (testing "with valid prompt names"
      (let [result (sut/prompts-install-command {:prompt-names ["simple" "medium"]})]
    ...
    (testing "with non-existent prompt"
      (let [result (sut/prompts-install-command {:prompt-names ["nonexistent"]})]
    ...
    (testing "with mix of valid and invalid prompts"
      (let [result (sut/prompts-install-command {:prompt-names ["simple" "invalid" "medium"]})]
