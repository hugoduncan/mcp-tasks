...
(defn- test-fixture
  ...
  [f]
  (let [dir (fs/create-temp-dir {:prefix "mcp-tasks-select-tasks-test-"})]
    (try
...
(defn- write-tasks-ednl
  ...
  [tasks]
  (write-ednl-test-file "tasks.ednl" tasks))
...
(deftest select-tasks-returns-multiple-tasks
  ...
  (testing "select-tasks returns multiple matching tasks"
    ;; Add three tasks
    (#'tools/add-task-impl (test-config) nil {:category "test" :title "Task One"})
    (#'tools/add-task-impl (test-config) nil {:category "test" :title "Task Two"})
    (#'tools/add-task-impl (test-config) nil {:category "test" :title "Task Three"})
...
(deftest select-tasks-limit-parameter
  ...
  (testing "select-tasks :limit parameter"
    ;; Add five tasks
    (#'tools/add-task-impl (test-config) nil {:category "test" :title "Task 1"})
    (#'tools/add-task-impl (test-config) nil {:category "test" :title "Task 2"})
    (#'tools/add-task-impl (test-config) nil {:category "test" :title "Task 3"})
    (#'tools/add-task-impl (test-config) nil {:category "test" :title "Task 4"})
    (#'tools/add-task-impl (test-config) nil {:category "test" :title "Task 5"})
...
(deftest select-tasks-unique-constraint
  ...
  (testing "select-tasks :unique constraint"
    (testing "returns task when exactly one matches"
      (#'tools/add-task-impl (test-config) nil {:category "test" :title "Unique Task"})
...
(deftest select-tasks-metadata-accuracy
  ...
  (testing "select-tasks metadata accuracy"
    ;; Add tasks
    (#'tools/add-task-impl (test-config) nil {:category "test" :title "Task A"})
    (#'tools/add-task-impl (test-config) nil {:category "test" :title "Task B"})
    (#'tools/add-task-impl (test-config) nil {:category "other" :title "Task C"})
...
(deftest select-tasks-type-filter
  ...
  (testing "select-tasks :type filter"
    ...
    (#'tools/add-task-impl (test-config) nil {:category "test" :title "Regular task" :type "task"})
    (#'tools/add-task-impl (test-config) nil {:category "test" :title "Bug fix" :type "bug"})
    (#'tools/add-task-impl (test-config) nil {:category "test" :title "New feature" :type "feature"})
    (#'tools/add-task-impl (test-config) nil {:category "test" :title "Another task" :type "task"})
    ...
    (testing "combines type filter with category filter"
      (#'tools/add-task-impl (test-config) nil {:category "other" :title "Other bug" :type "bug"})
...
(deftest select-tasks-status-filter
  ...
  (testing "select-tasks :status filter"
    (testing "filters by status open (default behavior)"
      ...
      (#'tools/add-task-impl (test-config) nil {:category "test" :title "Open task 1"})
      (#'tools/add-task-impl (test-config) nil {:category "test" :title "Open task 2"})
      (#'tools/add-task-impl (test-config) nil {:category "test" :title "To be closed"})
      ;; Complete one task
      (#'tools/complete-task-impl (test-config) nil {:title "To be closed"})
...
(deftest select-tasks-status-open-explicit
  ...
  (testing "select-tasks :status filter"
    (testing "explicitly filters by status open"
      (#'tools/add-task-impl (test-config) nil {:category "test" :title "Open task"})
      (#'tools/add-task-impl (test-config) nil {:category "test" :title "To close"})
      (#'tools/complete-task-impl (test-config) nil {:title "To close"})
...
(deftest select-tasks-status-with-category
  ...
  (testing "select-tasks :status filter"
    (testing "combines status filter with category filter"
      (#'tools/add-task-impl (test-config) nil {:category "test" :title "Test open"})
      (#'tools/add-task-impl (test-config) nil {:category "other" :title "Other open"})
      (#'tools/add-task-impl (test-config) nil {:category "test" :title "Test to close"})
      (#'tools/complete-task-impl (test-config) nil {:title "Test to close"})
...
(deftest select-tasks-task-id-filter
  ...
  (testing "select-tasks :task-id filter"
    ;; Add tasks
    (let [task1 (#'tools/add-task-impl (test-config) nil {:category "test" :title "Task One"})
          task1-data (json/read-str (get-in task1 [:content 1 :text]) :key-fn keyword)
          task1-id (get-in task1-data [:task :id])

          task2 (#'tools/add-task-impl (test-config) nil {:category "test" :title "Task Two"})
          task2-data (json/read-str (get-in task2 [:content 1 :text]) :key-fn keyword)
          task2-id (get-in task2-data [:task :id])

          task3 (#'tools/add-task-impl (test-config) nil {:category "other" :title "Task Three"})
