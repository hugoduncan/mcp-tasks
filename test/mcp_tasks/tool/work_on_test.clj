...
;; because the test environment runs in a fixed directory location, and we
;; cannot easily change the working directory mid-test to simulate being inside
;; a worktree.
;;
;; Affected Scenarios:
...
;; branch verification) is tested implicitly through the manage-worktree
;; function and would require integration testing with actual directory
;; switching.
