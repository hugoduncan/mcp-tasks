...
(deftest sync-with-sequential-operations-test
...
(deftest sync-error-handling-with-conflicts-test
...
(deftest sync-with-local-only-repo-test
...
(deftest file-locking-prevents-corruption-with-sync-test
